// This file is automatically generated by Lovable/Supabase tooling.
// Keep the authentication contract stable: server functions receive a verified
// Supabase client, user id and claims from the bearer token.
  ...
  async ({ next }) => {
    ...
    return next({
      context: {
        ...
        claims: data.claims,
        userEmail: typeof data.claims.email === 'string' ? data.claims.email.toLowerCase() : null,
      },
    });
  },
);