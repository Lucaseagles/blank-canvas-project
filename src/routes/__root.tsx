import { createRootRoute, Outlet, Scripts, HeadContent, useRouter } from "@tanstack/react-router";
  ...
  head: () => ({
    meta: [
      ...
      { title: "Ofertas Inteligentes — Descoberta e Video Commerce" },
      {
        name: "description",
        content:
          "Motor de descoberta de ofertas com curadoria inteligente, vídeos e alertas de preço em vários marketplaces.",
      },
    ],
  }),
  ...
  React.useEffect(() => {
    ...
    if (!sessionStorage.getItem(sessionKey)) {
      ...
      void Promise.resolve(
        (supabase as any).rpc("track_event", {
