...
function AdminSocialChannelsPage() {
  ...
  const edit = (c: any) => { setEditing(c); setForm({ platform: c.platform, channel_name: c.channel_name, channel_url: c.channel_url, is_active: c.is_active }); };
