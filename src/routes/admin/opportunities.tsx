...
function OpportunitiesPage() {
  ...
  return <div className="mx-auto max-w-7xl space-y-8 p-4 lg:p-8">
    ...
    <div className="grid gap-4 md:grid-cols-3"><Card><CardContent className="p-5"><Lightbulb className="mb-2 h-5 w-5 text-primary"/><p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Oportunidades abertas</p><p className="text-3xl font-black">{alerts.length}</p></CardContent></Card><Card><CardContent className="p-5"><p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Maior score</p><p className="text-3xl font-black">{alerts.length ? Number(alerts[0].score).toFixed(0) : 0}</p></CardContent></Card><Card><CardContent className="p-5"><p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Fonte</p><p className="text-lg font-black">Dados reais do catálogo</p></CardContent></Card></div>
