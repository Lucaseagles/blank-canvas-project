...
function isAllowedPreviewHost() {
  ...
  const isLovableProject = host.endsWith(".lovableproject.com");
  const isLovableDev = host.endsWith(".lovable.dev");
  const isLovablePreviewApp = host.endsWith(".lovable.app") && (host.startsWith("id-preview--") || host.startsWith("preview--"));
