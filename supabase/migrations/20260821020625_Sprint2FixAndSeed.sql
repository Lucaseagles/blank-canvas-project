...
BEGIN
    ...
    ('Sony WH-1000XM5 Wireless Noise Canceling Headphones', 'Industry-leading noise cancellation...', 1899.00, 2299.00, 17, 4.8, 1250, cat_elec_id, mark_amaz_id, 'https://amazon.com', ARRAY['https://images.unsplash.com/photo-1618366712277-7c0338a013ad?q=80&w=800&auto=format&fit=crop'], 'active', 'sony-wh-1000xm5'),
    ('Mechanical Keyboard - Custom RGB Backlit', 'High-performance mechanical switches...', 450.00, 599.00, 25, 4.6, 840, cat_peri_id, mark_ml_id, 'https://mercadolivre.com.br', ARRAY['https://images.unsplash.com/photo-1511467687858-23d96c32e4ae?q=80&w=800&auto=format&fit=crop'], 'active', 'mechanical-keyboard-rgb'),
    ('Ergonomic Office Chair - Mesh Support', 'Breathable mesh back...', 1290.00, 1590.00, 18, 4.7, 2100, cat_move_id, mark_shop_id, 'https://shopee.com.br', ARRAY['https://images.unsplash.com/photo-1592078650245-662f9904d7d4?q=80&w=800&auto=format&fit=crop'], 'active', 'ergonomic-chair-mesh'),
    ('Smart Watch Series 9 - 45mm Aluminum', 'Advanced health features...', 2899.00, 3299.00, 12, 4.9, 3400, cat_elec_id, mark_amaz_id, 'https://amazon.com', ARRAY['https://images.unsplash.com/photo-1544117518-30df578096a4?q=80&w=800&auto=format&fit=crop'], 'active', 'smart-watch-series-9')
    ON CONFLICT (slug) DO NOTHING;
END $$;
